        ...
        <div className={styles.hold}>
          <p>
            {status === "loading"
              ? "브리핑을 불러오는 중입니다."
              : status === "error"
                ? "브리핑을 불러오지 못했습니다. 대시보드로 돌아가 다시 열어 주세요."
      ...
      <main id="report-body" tabIndex={-1}>
        {!briefing && (
          <div className={styles.wide}>
            <p className={styles.notice}>
              이번 분석에서는 AI 해석을 만들지 못했습니다. 수치와 기본 설명만
              보여줍니다. 대시보드에서 분석을 업데이트해 주세요.
            </p>
          </div>
        )}
        ...
        <Band>
            ...
            <>
              ...
              <div className={styles.wide}>
                <p className={styles.caption}>
                  점 하나는 참여자 한 명입니다. 군·구 안의 점 위치에는 의미가
                  없고, 분석을 업데이트해도 기존 점은 움직이지 않습니다. 이
                  지도는 참여가 어디에 몰렸는지만 보여주며 군·구 사이의 요구
                  성향을 비교하지 않습니다.
                </p>
                <p className={styles.caption}>
                  이 지도는 참여자 {participants}명 전원을 세고, 04절
                  &lsquo;어떤 도시를 바라나&rsquo;는 그 축에 증거가 있는
                  참여자만 셉니다. 그래서 같은 극이라도 인원이 다릅니다.
                </p>
              </div>
            </>
          ) : (
          ...
          <div className={styles.read}>
            {briefing?.headline ? (
              ...
              <p className={styles.missing}>
                AI 해석을 만들지 못했습니다. 대시보드에서 분석을 업데이트해
                주세요.
              </p>
            )}
          </div>
        ...
        <Band>
          <div className={styles.read}>
            ...
            <p className={styles.serif}>
              비식별 인용 {quotes.length}건을 축·계획 부문·군·구·연령대로 걸러
              볼 수 있습니다.
            </p>
            <button
            ...
            {quotes.length === 0 && (
              <p className={styles.missing}>표시할 비식별 인용이 없습니다.</p>
            )}
        ...
        <Band>
          <div className={styles.read}>
            ...
            <p className={styles.serif}>
              참여자 {participants}명은 분석 시점에 저장되어 있던 제출본
              수입니다. 축별 집계의 인원은 그 축에 증거가 있는 참여자만 센
              값이므로 참여자 수보다 적을 수 있습니다.
            </p>
            <p className={styles.serif}>
              &lsquo;AI 해석&rsquo;으로 표시한 문장은 AI가 이번 집계를 읽고 쓴
              것입니다. 외부에 인용하기 전에 옆의 수치를 직접 확인하시기
              바랍니다.
            </p>
            <Link
              className={`${styles.button} ${styles.buttonghost}`}
